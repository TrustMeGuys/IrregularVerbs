...
SOURCES_TEST=main-test.c test_open_txt.c check_user_answer_test.c all_task.c test_task_one.c task_one.c task_two.c task_three.c task_three_read_file_test.c
VPATH=src test
